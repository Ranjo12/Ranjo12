...
/**
 * Servlet implementation class First_name
 */
public class First_name extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String Quer="update stud set stud_firstname=? where roll_no=?";
			String roll_no,firstname;
